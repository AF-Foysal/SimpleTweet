 ...
 *
 * NOTE: You may want to rename this object based on the service i.e TwitterClient or TwitterClient
 *
 */
class TwitterClient(context: Context) : OAuthBaseClient(
    ...
    companion object {
        val REST_API_INSTANCE: TwitterApi = TwitterApi.instance() // Change this
